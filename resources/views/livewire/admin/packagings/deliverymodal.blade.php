...
<x-modal.dialog wire:model.defer="showdeliveryModal" cssWidth="sm:w-6/12">
    <x-slot name="title">{{__("Delivery")}}</x-slot>
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-4">
                        ...
                        <div class="sm:grid sm:grid-cols-5 sm:gap-x-12 ">
                            <div class="col-span-2 sm:col-span-2">
                                <h3 class="text-lg font-medium leading-6 text-gray-900 mb-5">{{__('Delivery date')}}</h3>
                            </div>
                            ...
                            <div class="col-span-3 sm:col-span-3">
                                ...
                                <x-input.time :options="$dateOptions" wire:model.defer="editing.delivery_date" placeholder="Date de livraison" />
                                @error('editing.delivery_date')
    ...
    <x-slot name="footer">
        <x-button.secondary wire:click="$set('showdeliveryModal', false)">Annuler</x-button.primary>

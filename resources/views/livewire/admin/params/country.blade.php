                            ...
                            <x-table.cell>
                                <div class="flex justify-center items-center">
                                    <x-button.link class="flex items-center mr-3"
                                        ...
                                        <x-icon.edit class="w-4"></x-icon.edit> Modifier
                                    </x-button.link>
                                    <x-button.link class="text-red-600" wire:click="$toggle('showDeleteModal')">
                                        <x-icon.trash class="w-4"></x-icon.trash> Supprimer
                                    </x-button.link>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="is_delivery_country" class="font-medium text-gray-700">Pays de
                                destination</label>
                            <p class="text-gray-500">DCochez cet option pour afficher le pays dans la liste des pays de

<x-modal.dialog wire:model.defer="showAssignModal" cssWidth="sm:w-8/12">
    <x-slot name="title">Assigner une commande</x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="md:grid md:grid-cols-1 md:gap-6">
                ...
                @if(!is_null($editing))
                @include('client.order.inc.header', ['order' => $editing])
                ...
                <div class="mt-5">
                    ...
                    <div class="md:grid md:grid-cols-5 md:gap-6">
                        <div class="mt-5 md:mt-0 md:col-span-4">
                            @if(!is_null($editing))
                                @include('client.order.inc.menu', ['order' => $editing])
                                ...
                                <div class="p-4 bg-gray-100 rounded">
                                    ...
                                    <ul>
                                        <li class="py-3 w-full flex items-center justify-between text-sm">
                                            ...
                                            <span class="font-bold text-gray-900">{{ $editing->price   }}€</span>
                                        </li>
                                        <li class="py-3 w-full flex items-center justify-between text-sm">
                                            <span>{{ __('Insurance Fees') }}</span>
                                            <span class="font-bold text-gray-900">{{ $editing->insurance }}€</span>
                                        </li>
                                        <li
                                            ...
                                            <span class="font-bold text-gray-900">{{ $editing->total }}€</span>
                                        </li>
                                    </ul>
                        ...
                        <div class="md:col-span-1">
                            @if(!is_null($editing))
                                ...
                                @include('client.order.inc.sidebar', ['order' => $editing])
    ...
    <x-slot name="footer">
        <x-button.secondary wire:click="$set('showAssignModal', false)">Fermer</x-button.secondary>
    </x-slot>
</x-modal.dialog>
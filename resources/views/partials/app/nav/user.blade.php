<div class="flex space-x-4 items-center">
    ...
    @auth
        <span>
            <svg class="h-4 w-4 text-gray-500 notificationBell" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
        ...
        <x-dropdown align="right" width="48">
            ...
            <x-slot name="content">
                <x-responsive-nav-link href="{{ route('profile.index') }}">Mon Profil</x-responsive-nav-link>
